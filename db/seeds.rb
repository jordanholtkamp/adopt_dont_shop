...
steve = otter_shelter.pets.create(image: "https://cdn.mainichi.jp/vol1/2018/05/12/20180512p2a00m0na022000p/9.jpg?4", name: 'Steve', approximate_age: 1, sex: 'Male', description: 'I am a happy otter who likes to hangout with people')
...
clark = cat_shelter.pets.create(image: "https://www.humanesociety.org/sites/default/files/styles/1240x698/public/2018/06/cat-217679.jpg?h=c4ed616d&itok=3qHaqQ56", name: 'Clark', approximate_age: 3, sex: 'Male', description: 'I am a cuddly kitty and I like milk')